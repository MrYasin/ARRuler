...
//  AR Ruler
//
//  Created by Yasin Cengiz on 6.10.2019.
...
//                print(hitResult)
    ...
    func calculate() {
        ...
        let distance = simd_distance(a,b) * 100
...
//        let distance = sqrt(pow(a, 2) + pow(b, 2) + pow(c, 2))
        ...
        updateText(text: String(format: "%.2f", distance) , atPosition: dotNodes[1].position)
        
    }
    
    
    // Function for distance shown on the screen
